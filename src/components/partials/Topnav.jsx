  ...
  return (
    <div className="w-[80%] h-[10vh] relative flex  items-center  mx-auto">
      ...
      <input
        ...
        value={query}
        className="w-[50%] text-white mx-10 p-3 text-xl outline-none border-none bg-transparent"
        type="text"
      ...
      <div className=" z-10    absolute  w-[50%] max-h-[40vh]  bg-zinc-200 top-[100%] left-[5%] overflow-auto rounded ">
        {searches.map((s, i) => (
          <Link
            to={`/${s.media_type}/details/${s.id}`}
            key={i}
            className=" hover:text-black hover:bg-zinc-300 duration-300
         text-zinc-600 font-semibold  w-[100%] p-8 flex justify-start items-center border-b-2 border-zinc-100"
          >
            <img
